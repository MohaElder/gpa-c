...
//CHANGE THESE VALUES TO CUSTOMIZE GPAC
    var credits = 30.5;//Main Credit
    var SubjectList = new Array ("Chi","Eng","Math","Chem","Phy","Ele","His")//Subjects
    var CreditList = new Array ("3.0@1","6.5@1","6.5@0","4.0@0","4.0@0","4.0@0","2.5@0")//Subjects'credit and the mark of whether it is language or nonlanguage. 1 = Language, 0 = NonLanguage
