function Run()
 {
   var total = 0;
   var rank = "";
   var SubjectList = new Array ("Chi","Eng","Math","Bio","Phy","His","Geo")
...
function getGpa(subject)
{
  ...
  if(subject=="Math")
    return 7.5*getNL(subLev,subScore);
  if(subject=="Chi")
    return 5*getL(subLev,subScore);
  if(subject=="Eng")
    return 7.5*getL(subLev,subScore);
  if(subject=="Bio")
    return 3*getNL(subLev,subScore);
  if(subject=="Phy")
    return 3*getNL(subLev,subScore);
  if(subject=="His")
    return 2*getNL(subLev,subScore);
  if(subject=="Geo")
    return 2*getNL(subLev,subScore);
}
